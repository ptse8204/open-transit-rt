...
func buildOperationsSetupWizard(page operationsPage) operationsSetupWizardView {
	stages := []operationsSetupWizardStage{
		...
		setupWizardStage(
			...
			"Use the existing CLI import path or GTFS Studio draft publish path; browser ZIP import is not implemented here.",
			"/admin/gtfs-studio",
		...
		setupWizardStage(
			...
			"Review schedule, Vehicle Positions, Trip Updates, Alerts, and feeds.json metadata without changing public routes.",
