...
var operationsRouteRegistry = []operationsRouteMeta{
	{Section: "dashboard", Path: "/admin/operations", JSONPath: "/admin/operations.json", NavLabel: "Start Here", PageTitle: "Start Here", GroupID: "start", Methods: []string{"GET"}, NoStore: true},
	{Section: "launchpad", Path: "/admin/operations/launchpad", JSONPath: "/admin/operations/launchpad.json", NavLabel: "Launchpad", PageTitle: "Launchpad", GroupID: "start", Methods: []string{"GET"}, NoStore: true},
	...
	{Section: "feed-health", Path: "/admin/operations/feed-health", JSONPath: "/admin/operations/feed-health.json", NavLabel: "Check Feeds", PageTitle: "Feed Health", GroupID: "feeds", Methods: []string{"GET"}, NoStore: true},
	{Section: "validation-center", Path: "/admin/operations/validation-center", JSONPath: "/admin/operations/validation-center.json", NavLabel: "Validation Center", PageTitle: "Validation Center", GroupID: "feeds", Methods: []string{"GET"}, NoStore: true},
	{Section: "validation-health", Path: "/admin/operations/validation-health", JSONPath: "/admin/operations/validation-health.json", NavLabel: "Validator Health", PageTitle: "Validator Health", GroupID: "feeds", Methods: []string{"GET", "POST"}, NoStore: true},
	{Section: "realtime", Path: "/admin/operations/realtime", JSONPath: "/admin/operations/realtime.json", NavLabel: "Realtime", PageTitle: "Realtime", GroupID: "realtime", Methods: []string{"GET"}, NoStore: true},
	{Section: "prediction-lab", Path: "/admin/operations/prediction-lab", JSONPath: "/admin/operations/prediction-lab.json", NavLabel: "Prediction Lab", PageTitle: "Prediction Lab", GroupID: "realtime", Methods: []string{"GET"}, NoStore: true},
	{Section: "alerts", Path: "/admin/alerts/console", NavLabel: "Alerts", GroupID: "realtime", Methods: []string{"GET"}, ExternalAdminSurface: true},
	{Section: "telemetry", Path: "/admin/operations/telemetry", NavLabel: "Telemetry Freshness", PageTitle: "Telemetry Freshness", GroupID: "vehicles", Methods: []string{"GET"}, NoStore: true},
	{Section: "devices", Path: "/admin/operations/devices", NavLabel: "Devices & Tokens", PageTitle: "Devices & Tokens", GroupID: "vehicles", Methods: []string{"GET", "POST"}, NoStore: true},
	{Section: "telemetry-simulator", Path: "/admin/operations/telemetry-simulator", JSONPath: "/admin/operations/telemetry-simulator.json", NavLabel: "Telemetry Simulator", PageTitle: "Telemetry Simulator", GroupID: "vehicles", Methods: []string{"GET"}, NoStore: true},
	...
	{Section: "audit", Path: "/admin/operations/audit", JSONPath: "/admin/operations/audit.json", NavLabel: "Audit History", PageTitle: "Audit History", GroupID: "help", Methods: []string{"GET"}, NoStore: true},
	{Section: "evidence", Path: "/admin/operations/evidence", NavLabel: "Evidence Guidance", PageTitle: "Evidence Guidance", GroupID: "help", Methods: []string{"GET"}, NoStore: true},
}
