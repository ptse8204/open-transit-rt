...
func buildOperatorChecklist(page operationsPage) operatorChecklistView {
	groups := []operatorChecklistGroup{
		...
		{ID: "feeds", Label: "Feeds", Rows: []operatorChecklistRow{
			...
			row("feeds_vehicle_positions", "Vehicle Positions feed", feedChecklistStatus(page, "vehicle_positions"), "feed discovery", feedEvidence(page, "vehicle_positions"), "Confirm telemetry, public protobuf output, and feed discovery records.", "Vehicle Positions signals are not consumer acceptance.", docs("docs/deployment/reference-deployment-doctor.md", "docs/tutorials/operator-smoke-and-support-bundle.md"), feedHeuristics(page, "vehicle_positions")),
