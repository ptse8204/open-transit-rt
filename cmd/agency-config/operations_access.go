...
type operationsRolePermission struct {
	...
	TechnicalHelperNote string `json:"technical_helper_note"`
		...
		Roles: []operationsRolePermission{
			{
				...
				TechnicalHelperNote: "Use for setup changes, browser GTFS import, validator runs, device credential changes, and other explicitly admin-only actions.",
				DoesNotProve:        "Admin role does not prove deployment ownership, agency approval, hosted operation, or release readiness.",
			},
			{
				ID:                  "editor",
				Label:               "Editor",
				...
				TechnicalHelperNote: "Use when schedule or content review needs a narrower role than admin.",
			...
			},
			{
				...
				TechnicalHelperNote: "Use for daily operational review and escalation to an admin or technical helper.",
				DoesNotProve:        "Operator role does not prove service uptime, SLA coverage, or public launch readiness.",
			},
			{
				ID:                  "read_only",
				Label:               "Read only",
				...
				TechnicalHelperNote: "Use for oversight, walkthroughs, and support review without changing backend state.",
				DoesNotProve:        "Read-only access does not prove an agency, consumer, vendor, or regulator has approved anything.",
			},
		},
		Denied: []operationsAccessDeniedPath{
			{
				...
				DoesNotProve: "Denied access does not prove data exists or does not exist for another agency.",
			},
			{
			...
			},
			{
				...
				DoesNotProve: "A failed form safety check does not prove the requested action would otherwise be valid.",
			},
		},
	}
}
