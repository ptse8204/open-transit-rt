...
func buildOperationsReadinessV2(page operationsPage) operationsReadinessV2View {
	rows := []operationsReadinessV2Row{
		readinessV2Row(
			...
			"Does not prove final-root ownership, agency approval, consumer discovery, public launch, or CAL-ITP/Caltrans compliance.",
		...
		readinessV2Row(
			...
			"Does not prove validator-clean production data, no-warning compliance, final-root approval, or consumer ingestion.",
		...
		readinessV2Row(
			...
			"Does not prove production-grade ETA quality, real-world ETA accuracy, consumer display, or compliance.",
		...
		readinessV2Row(
			...
			"Does not prove agency-reviewed alert content, public launch completion, consumer display, or compliance.",
		...
		readinessV2Row(
			...
			"Does not prove consumer acceptance, no-error production compliance, public fetch success, or agency approval.",
		...
		readinessV2Row(
			...
			"Does not prove service-level commitments, uptime proof, hosted-service availability, production readiness, or managed support.",
		...
		readinessV2Row(
			...
			"Does not prove agency adoption, managed hosting, service-level commitments, production readiness, public launch, or compliance.",
