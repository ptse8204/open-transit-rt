	...
	return connectorTestsView{
		...
		Commands: []connectorTestCommand{
			...
			connectorTestCommandView(
				...
				"Telemetry, prediction, validator, and monitoring conformance cases are present, synthetic, and fail closed, including Phase 101 V2 missing-field, invalid-coordinate, public-mutation, command-blocking, and unredacted-destination cases.",
