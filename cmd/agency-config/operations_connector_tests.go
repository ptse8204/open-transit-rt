	...
	return connectorTestsView{
		...
		Commands: []connectorTestCommand{
			...
			connectorTestCommandView(
				...
				"Telemetry, prediction, validator, monitoring, and consumer discovery conformance cases are present, synthetic, and fail closed, including missing-field, invalid-coordinate, public-mutation, command-blocking, unredacted-destination, no-submit, and no-status-mutation cases.",
				...
				[]string{"docs/tutorials/external-adapter-conformance.md", "docs/connectors/plugin-contract.md", "docs/connectors/redaction-first-recipes.md"},
			),
			connectorTestCommandView(
			...
			connectorTestCommandView(
				...
				"Malformed, stale, future, wrong-agency, unknown-device, low-quality, duplicate, out-of-order, missing-required-field, and invalid-coordinate telemetry cases remain fail-closed.",
			...
			connectorTestCommandView(
				...
				"Timeout, malformed, stale, wrong-agency, low-confidence, missing Vehicle Positions reference, and public-mutation-attempt prediction outputs remain withheld or fail-closed.",
			...
			connectorTestCommandView(
				...
				"Validator connector fixtures use allowlisted validator IDs and block manifest-provided command behavior.",
				"Synthetic validator allowlist and command-blocking fixtures.",
			...
			connectorTestCommandView(
				...
				"Monitoring/export fixtures keep redaction, no-send defaults, and unredacted-destination blocking.",
				"Synthetic monitoring redaction, no-send, and destination-redaction fixtures.",
			...
			connectorTestCommandView(
				"adapter-conformance-consumer-discovery",
				"Consumer/discovery connector cases",
				"go run ./cmd/adapter-conformance consumer_discovery --suite testdata/adapter-conformance",
				"Consumer discovery fixtures keep public feed URL metadata review offline, prepared-only, no-submit, and no-status-mutation.",
				"Synthetic consumer discovery metadata, status-mutation blocking, and submission-automation blocking fixtures.",
				"Fix metadata or connector boundaries without touching the consumer tracker, protected evidence paths, or external portals.",
