# Apple Maps Consumer Evidence Template
...
Validator success and public fetch proof are supporting evidence only. They are not Apple Maps acceptance or ingestion.
