...
- Next action: Operator prepares the Bing Maps submission packet, submits through the official Microsoft/Bing Maps transit data workflow, and stores redacted receipt evidence before changing status.
- Allowed public wording: "No Bing Maps submission has been made."
...
Validator success and public fetch proof are supporting evidence only. They are not Bing Maps acceptance or ingestion.
