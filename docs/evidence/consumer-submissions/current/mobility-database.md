# Mobility Database Current Aggregator Evidence
...
- Next action: Operator prepares the Mobility Database submission or registration packet, submits through the official Mobility Database workflow, and stores redacted receipt evidence before changing status.
- Allowed public wording: "No Mobility Database submission has been made."
...
Validator success and public fetch proof are supporting evidence only. They are not Mobility Database acceptance, listing, or downstream consumer ingestion.
