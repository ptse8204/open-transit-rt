...
- Next action: Operator prepares the Moovit submission packet, submits through the official Moovit data partner workflow, and stores redacted receipt evidence before changing status.
- Allowed public wording: "No Moovit submission has been made."
...
Validator success and public fetch proof are supporting evidence only. They are not Moovit acceptance or ingestion.
