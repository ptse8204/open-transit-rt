...
- Next action: Operator prepares the Transit App submission packet, submits through the official Transit data partner workflow, and stores redacted receipt evidence before changing status.
- Allowed public wording: "No Transit App submission has been made."
...
Validator success and public fetch proof are supporting evidence only. They are not Transit App acceptance or ingestion.
