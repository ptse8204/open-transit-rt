...
Fix the large public GTFS import/publish timeout exposed by Phase 33, ensure
timeout failures persist a clean failed import report, then retry Phase 33
Outcome C before stronger public-GTFS handling wording.
