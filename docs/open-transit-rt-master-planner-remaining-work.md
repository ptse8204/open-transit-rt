...
```text
Continue active Phase 87 -- Public Feed Readiness And Docs Portal. Keep
release-cut cleanup, connector maturity claims, and optional evidence tracks
