...
- [Validator Automation And Health Gates](../phase-46-validator-automation-and-health-gates.md): review private validator tooling, artifact, stale-result, and next-action diagnostics without creating evidence.
...
and the [OCI/OCL Reference Deployment Productization](../phase-36-oci-reference-deployment-productization.md)
