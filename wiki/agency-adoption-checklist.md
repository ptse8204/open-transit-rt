...
- synthetic telemetry reaches authenticated ingest.
...
6. Review `/admin/operations/readiness` through a private admin boundary.
7. Keep trial notes private unless they are redacted and intended for public
   contribution.

Detailed guide: [Self-Hosted Operator Trial](../docs/tutorials/self-hosted-operator-trial.md).
