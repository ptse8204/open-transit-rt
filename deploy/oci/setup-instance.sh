...
echo "  2. scripts/oci-pilot.sh push"
echo "  3. scripts/oci-pilot.sh units"
echo "  4. scripts/oci-pilot.sh migrate"
echo "  5. scripts/oci-pilot.sh start"
echo "  6. scripts/oci-pilot.sh token <agency-id> && scripts/oci-pilot.sh bootstrap"
